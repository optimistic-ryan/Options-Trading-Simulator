...
CREATE OR REPLACE FUNCTION calculate_option_prob_in_the_money(p_option_type CHAR(4), p_current_price DECIMAL, p_strike_price DECIMAL, p_risk_free_rate DECIMAL, p_time_to_maturity DECIMAL, p_volatility DECIMAL, p_dividend_yield DECIMAL)
RETURNS DECIMAL AS $$
DECLARE
  d1 DECIMAL;
  d2 DECIMAL;
